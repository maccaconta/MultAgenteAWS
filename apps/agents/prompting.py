...
class PromptComposer:
    ...
    def compose_consultation_instruction(prompt_bundle: dict[str, Any]) -> str:
        ...
        return (
            ...
            "1. Identifique a entidade principal da pergunta.\n"
            "2. Identifique o alvo informacional e a secao documental mais provavel.\n"
            "3. Tente consultas alternativas usando entidade + alvo + sinonimos + secoes provaveis.\n"
            "4. Quando houver resposta na base, entregue primeiro o fato exato e depois o contexto.\n"
            "5. Se nao encontrar, diga qual campo foi procurado, quais familias de reformulacao tentou e se houve sinal parcial.\n"
            "6. Antes de concluir ausencia, tente multiplas reformulacoes coerentes.\n\n"
            "Regras obrigatorias:\n"
            ...
            "- tente buscar a evidencia mais proxima mesmo quando nao houver confirmacao plena.\n\n"
    ...
    def compose_synthesis_instruction(prompt_bundle: dict[str, Any]) -> str:
        ...
        return (
            ...
            "- em follow-ups curtos ou vagos, use o contexto anterior e continue ajudando, sem devolver pedido generico de esclarecimento;\n"
            "- quando um fato documental tiver sido confirmado, use-o como ponto de apoio e depois reconduza o usuario ao treinamento;\n"
            "- ao final, sempre sugira um proximo passo util.\n\n"
            "Persona:\n"
    ...
    def compose_compliance_instruction(prompt_bundle: dict[str, Any]) -> str:
        ...
        return (
            ...
            "- atuar como verificador formal de evidencias RAG para respostas factuais/documentais;\n"
            "- classificar a confianca factual como supported, uncertain ou unsupported;\n"
    ...
    def compose_supervisor_instruction(prompt_bundle: dict[str, Any]) -> str:
        ...
        return (
            ...
            "- para perguntas factuais/documentais, consultation e obrigatorio e deve recuperar a evidencia mais proxima da base antes da resposta final;\n"
            "- use compliance como verificador formal da suficiência de evidência factual nas respostas documentais;\n"
            "- quando houver suporte factual suficiente, responda o fato primeiro e depois traga o usuario de volta para a trilha de treinamento;\n"
            "- quando a evidencia for incerta ou insuficiente, nao invente: explique a limitacao factual e ainda assim mantenha utilidade para o treinamento.\n\n"
            "Regras obrigatorias:\n"
            "- nunca responda apenas que a ferramenta de consulta nao esta disponivel;\n"
            "- se o usuario fizer follow-up curto ou vago, use o contexto imediatamente anterior e continue ajudando;\n"
            "- para perguntas de treinamento, entregue uma resposta util no mesmo turno e nao apenas uma pergunta de retorno;\n"
